...
class Channel(models.Model):
    ...
    direct_user1 = models.ForeignKey(User, null=True, blank=True,
                                     related_name='direct_channels_as_1',
                                     on_delete=models.CASCADE)
    direct_user2 = models.ForeignKey(User, null=True, blank=True,
                                     related_name='direct_channels_as_2',
                                     on_delete=models.CASCADE)
    # For NODE-linked:
    node         = models.ForeignKey('graph.Node', null=True, blank=True,
...
class Message(models.Model):
    ...
    attachment = models.ForeignKey('files.Version', null=True, blank=True,
